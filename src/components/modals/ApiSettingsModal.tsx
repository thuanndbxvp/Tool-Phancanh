                            ...
                            <div>
                                ...
                                <div className="mt-4 p-4 bg-slate-900/50 rounded-lg border border-slate-700/50 space-y-3">
                                    ...
                                    <div className="text-xs text-amber-500/80 mb-2 italic">
                                        💡 Mẹo: <b>qwen-3.7-flash</b> được chọn làm mặc định vì đây là model rẻ nhất mà vẫn xử lý phân cảnh (vốn tiêu tốn lượng lớn input token) một cách cực kỳ thông minh.
                                    </div>
                                    {kymaModels.length > 0 ? (
